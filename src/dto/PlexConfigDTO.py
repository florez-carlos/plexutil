...
def __eq__(self, other):
    ...
    return self.music_folder_path == other.music_folder_path\
    and self.movie_folder_path == other.movie_folder_path\
    and self.tv_folder_path == other.tv_folder_path\
    and self.music_playlist_file_path == other.music_playlist_file_path\
    and self.host == other.host\
    and self.port == other.port\
    and self.token == other.token

def __hash__(self):
    return hash((self.music_folder_path, self.movie_folder_path, self.tv_folder_path,self.music_playlist_file_path,self.host,self.port,self.token))
