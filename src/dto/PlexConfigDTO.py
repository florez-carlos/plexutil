...
def __eq__(self, other):
    ...
    and self.plexutil_path == other.plexutil_path \
    and self.host == other.host\
    and self.port == other.port\
    and self.token == other.token

def __hash__(self):
    return hash((self.music_folder_path, self.movie_folder_path, self.tv_folder_path,self.plexutil_path, self.host,self.port,self.token))
